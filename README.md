...
3. Once the skill is created, from the skill menu, select `Interaction Model -> JSON Editor` and paste in the contents of your preferred language's interaction model (English: [en.json](/../../raw/main/interaction_models/en.json)). Then select `Save Model`. Check all available languages [here](https://github.com/srichter/asksonic/tree/main/interaction_models)
